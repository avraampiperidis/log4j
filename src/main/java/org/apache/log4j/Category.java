...
public class Category implements AppenderAttachable {
  ...
  */
  ...
  public HttpLog debug(Object message) {
  ...
  public HttpLog debug(Object message, Throwable t) {
      if (repository.isDisabled(Level.DEBUG_INT)) {
  ...
  /**
    ...
    @param message the message object to log */
  public HttpLog error(Object message) {
  ...
  /**
   ...
   @param message the message object to log.
   @param t the exception to log, including its stack trace.  */
  public HttpLog error(Object message, Throwable t) {
      if (repository.isDisabled(Level.ERROR_INT)) {
          return new HttpLog(message,t);
      }
  ...
  /**
    ...
    @param message the message object to log */
  public HttpLog fatal(Object message) {
  ...
  /**
   ...
   @param message the message object to log.
   @param t the exception to log, including its stack trace.  */
  public HttpLog fatal(Object message, Throwable t) {
    if(repository.isDisabled(Level.FATAL_INT)) {
        return new HttpLog(message, t);
    }
    if(Level.FATAL.isGreaterOrEqual(this.getEffectiveLevel())) {
  ...
  */
  ...
  /**
    ...
    @param message the message object to log */
  public HttpLog info(Object message) {
  ...
  /**
   ...
   @param message the message object to log.
   @param t the exception to log, including its stack trace.  */
  public HttpLog info(Object message, Throwable t) {
      if (repository.isDisabled(Level.INFO_INT)) {
          return new HttpLog(message,t);
      }
 ...
 /**
    This generic form is intended to be used by wrappers.
 */
  public HttpLog log(Priority priority, Object message) {
    if(repository.isDisabled(priority.level)) {
  ...
  */
  ...
  /**
    ...
    @param message the message object to log.  */
  public HttpLog warn(Object message) {
  ...
  /**
   ...
   @param message the message object to log.
   @param t the exception to log, including its stack trace.  */
  public HttpLog warn(Object message, Throwable t) {
      if (repository.isDisabled(Level.WARN_INT)) {
          return new HttpLog();
      }

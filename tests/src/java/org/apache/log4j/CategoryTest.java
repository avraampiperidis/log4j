...
import org.apache.log4j.httplog.HttpLog;
...
public class CategoryTest extends TestCase {
  ...
  public void testInfo() throws MalformedURLException {

    Logger logger = Logger.getLogger("org.example.foo");
    Priority debug = Level.INFO;
    logger.setPriority(debug);
    assertNotNull(logger);
    assertEquals(HttpLog.class,logger.info("message").getClass());
    assertEquals(HttpLog.class,logger.info(null).getClass());
    assertEquals(HttpLog.class,logger.info("message").doPost("http://www.url.co").getClass());
    assertEquals("http://www.url.co",logger.info("message").doPost("http://www.url.co").getUrl());
    assertEquals(HttpLog.class,logger.info("message").doPost("http://www.url.co").getClass());
    assertEquals(HttpLog.class,logger.info("message",new Throwable()).getClass());
    assertEquals(HttpLog.class,logger.info(null,new Throwable("throwable_test")).getClass());
    assertEquals(HttpLog.class,logger.info(null,new Exception("Exception_test")).getClass());
    assertEquals(HttpLog.class,logger.info(null,new Error("Error_test")).getClass());
  ...
  public void testDebug() {
    ...
    logger.setPriority(debug);
    assertNotNull(logger);
    assertEquals(HttpLog.class,logger.debug("message").getClass());
    assertEquals(HttpLog.class,logger.debug("message",new Throwable()).getClass());
